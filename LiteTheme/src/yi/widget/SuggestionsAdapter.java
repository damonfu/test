...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView,
        ...
        super(context,
                IDHelper.getLayoutByName("search_dropdown_item_icons_2line"),
        ...
        Context activityContext = ReflectUtil.SearchableInfoReflect.getActivityContext(mSearchable,
                mContext);
        mProviderContext = ReflectUtil.SearchableInfoReflect.getActivityContext(mSearchable,
                activityContext);
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        try {
            cursor =   ReflectUtil.SearchManagerResultReflect.getSuggestions(mSearchManager, mSearchable, query, QUERY_LIMIT);
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            mText1 = (TextView) v.findViewById(IDHelper.getIdByName("text1"));
            mText2 = (TextView) v.findViewById(IDHelper.getIdByName("text2"));
            mIcon1 = (ImageView) v.findViewById(IDHelper.getIdByName("icon1"));
            mIcon2 = (ImageView) v.findViewById(IDHelper.getIdByName("icon2"));
            mIconRefine = (ImageView) v.findViewById(IDHelper.getIdByName("edit_query"));
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (mUrlColor == null) {
            ...
            mContext.getTheme().resolveAttribute(IDHelper.getAttrByName("textColorSearchUrl"), colorValue, true);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            View v = newView(mContext, this.getCursor(), parent);
            if (v != null) {
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            if (ContentResolver.SCHEME_ANDROID_RESOURCE.equals(scheme)) {
                ...
                Object r = ReflectUtil.ContentResolverReflect.getResourceId(mProviderContext.getContentResolver(), uri);
                Resources resource = ReflectUtil.OpenResourceIdResultReflect.getResources(r);
                int id = ReflectUtil.OpenResourceIdResultReflect.getId(r);
                try {
