...
public class DateElement extends TextElement {
    ...
    public boolean matchTag(String tagName) {
        return Constants.TAG_DATE.equals(tagName)
                || Constants.TAG_DATE_BAIDU.equals(tagName);
    }
    ...
    public void onTimeTick(Time time) {
        // Logger.i("Tick", this+" onTimeTick="+time);
    ...
    public void setFormat(String format) {
        ...
        if (format != null) {
            // check whether have NNNN, it means China lunar
            if (format.contains("NNNN")) {
                Lunar lunar = new Lunar(Calendar.getInstance());
                String lunarString = lunar.toString();
                // Logger.v("date", "lunar="+lunarString);
                format = format.replaceAll("NNNN", lunarString);
                // Logger.v("date", "Lunar format="+format);
            }
            ...
            // Logger.v("date", "format=" + format + ", string=" + dateString);
        }
    }
    ...
    public static class Lunar {
        ...
        public Lunar(Calendar cal) {
            ...
            try {
                ...
                Logger.w("Exception: DateElement:", "Lunar" + e.getMessage());
            }
