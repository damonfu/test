...
package com.baidu.themeanimation.net.sourceforge.jeval;
...
import com.baidu.themeanimation.net.sourceforge.jeval.function.math.MathFunctions;
import com.baidu.themeanimation.net.sourceforge.jeval.function.string.StringFunctions;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.AdditionOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.ClosedParenthesesOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.DivisionOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.EqualOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.ModulusOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.MultiplicationOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.NotEqualOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.OpenParenthesesOperator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.Operator;
import com.baidu.themeanimation.net.sourceforge.jeval.operator.SubtractionOperator;
/**
 ...
 * com.baidu.themeanimation.net.sourceforge.jeval.functions.math and
 * com.baidu.themeanimation.net.sourceforge.jeval.functions.string packages for details on these ready to
...
public class Evaluator {
	...
	public void putVariable(final String variableName,
		...
		if (variables.containsKey(variableName)) {
		    String key = variableName + ".old_value";
...
//			operatorStack = (Stack)ExpressionManager.getInstance().getOperatorStack(expression);
//			operandStack  = (Stack)ExpressionManager.getInstance().getOperandStack(expression);
...
//				ExpressionManager.getInstance().setOperandStack(previousExpression, (Stack)previousOperandStack.clone());
//				ExpressionManager.getInstance().setOperatorStack(previousExpression, (Stack)previousOperatorStack.clone());
	 ...
	 */
	int numOperators;      //add by luqingyuan
...
//changed by luqingyuan: not support now
...
//		operators.add(new ModulusOperator());
	...
	private NextOperator processFunction(final String expression,
		...
		if (function == null) {
		    Log.w("unsupported", "function name = " + functionName);
...
//changed by luqingyuan
	//		final int numOperators = operators.size();
			for (int operatorCtr = 2; operatorCtr < numOperators; operatorCtr++) {
              ...
              if (c == operator.getSymbol().charAt(0)) {
...
//						NextOperator nextOperator = new NextOperator(operator,
//								charCtr);
//		              Log.v("Evaluator","operator: "+operator.getSymbol());
//						return nextOperator;
//					}
//				} else {
//					// Look for a match.
