...
import com.yi.internal.view.menu.MenuView.ItemView;
...
public final class MenuItemImpl implements MenuItem {
    ...
    MenuItemImpl(MenuBuilder menu, int group, int id, int categoryOrder, int ordering,
        ...
        if (sPrependShortcutLabel == null) {
            ...
            sPrependShortcutLabel = menu.getContext().getResources().getString(
                    IDHelper.getStringByName("prepend_shortcut_label"));
            sEnterShortcutLabel = menu.getContext().getResources().getString(
                    IDHelper.getStringByName("menu_enter_shortcut_label"));
            sDeleteShortcutLabel = menu.getContext().getResources().getString(
                    IDHelper.getStringByName("menu_delete_shortcut_label"));
            sSpaceShortcutLabel = menu.getContext().getResources().getString(
                    IDHelper.getStringByName("menu_space_shortcut_label"));
        }
    ...
    public MenuItem setEnabled(boolean enabled) {
        ...
        /*
         * Android original code as below
         * 
        if (enabled) {
            mFlags |= ENABLED;
        } else {
