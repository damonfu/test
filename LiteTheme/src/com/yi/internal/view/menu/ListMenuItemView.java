    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(
                attrs, IDHelper.getStyleableArrByName(IDHelper.MenuView.self), defStyle, 0);

        mBackground = a.getDrawable(IDHelper.getStyleableByName(IDHelper.MenuView.itemBackground));
        mTextAppearance = a.getResourceId(IDHelper.getStyleableByName(IDHelper.MenuView.itemTextAppearance), -1);
        mPreserveIconSpacing = a.getBoolean(
                IDHelper.getStyleableByName(IDHelper.MenuView.preserveIconSpacing), false);             //preserveIconSpacing is private attribute
