...
public class MenuBuilder implements Menu {
    ...
    //Menu.CATEGORY_MASK
    public static final int BUILD_CATEGORY_MASK = 0xffff0000;
    //Menu.USER_MASK
    public static final int BUILD_USER_MASK = 0x0000ffff;
    //Menu.CATEGORY_SHIFT
    public static final int BUILD_CATEGORY_SHIFT = 16;
    ...
    private static final int MAX_ACTION_BUTTON_NUM = 3;
    ...
    /*BEGIN jianglin01@baidu.com, 31/3/2012, Fix TextView selection action mode issue*/
    /**
     * @hide
     */
    ...
    /*END, Fix TextView selection action mode issue*/
    /**
    ...
    private static int getOrdering(int categoryOrder) {
        final int index = (categoryOrder & BUILD_CATEGORY_MASK) >> BUILD_CATEGORY_SHIFT;

        if (index < 0 || index >= sCategoryToOrder.length) {
            throw new IllegalArgumentException("order does not contain a valid category.");
        }

        return (sCategoryToOrder[index] << BUILD_CATEGORY_SHIFT) | (categoryOrder & BUILD_USER_MASK);
    }
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        mShortcutsVisible = shortcutsVisible
                ...
                && mResources.getBoolean(
                        IDHelper.getBoolByName("config_showMenuShortcutsWhenKeyboardPresent"));  //private boolean
    }
    ...
    public void flagActionItems() {
        ...
        if (flagged) {
            ...
            for (int i = 0; i < itemsSize; i++) {
                ...
                if (item.isActionButton() && mActionItems.size()<MAX_ACTION_BUTTON_NUM) {
