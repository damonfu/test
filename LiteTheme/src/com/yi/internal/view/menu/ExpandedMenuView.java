...
public final class ExpandedMenuView extends ListView implements ItemInvoker, MenuView, OnItemClickListener {
    ...
    public ExpandedMenuView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, IDHelper.getStyleableArrByName(IDHelper.MenuView.self), 0, 0);
        mAnimations = a.getResourceId(IDHelper.getStyleableByName(IDHelper.MenuView.windowAnimationStyle), 0);
        a.recycle();
